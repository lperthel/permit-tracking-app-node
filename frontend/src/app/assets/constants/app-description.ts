export const APP_DESCRIPTION = ` This application is a modern, full-stack web platform built using a
...
export const APP_DESCRIPTION_ENCODED = `This application is a modern, full-stack web platform built using a 
  serverless architecture. The frontend is developed with 
...
export const APP_HEADER = 'Serverless Inventory System';
